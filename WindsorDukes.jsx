...
const FIXED_TESTS = {
  3:{title:"Test 3 — Algebra & Equations",difficulty:"Moderate–Challenging",color:"bg-violet-600",light:"bg-violet-50",border:"border-violet-400",badge:"🟣",questions:[
    ...
    {num:4,q:"Solve the following simultaneous equations:\n3x + y = 11\nx − y = 1",opts:["x=2,y=5","x=3,y=2","x=4,y=−1","x=1,y=8","x=5,y=−4"],ans:1,topic:"algebra",exp:"Add: 4x=12→x=3, y=2.",tutorial:["📌 Add equations to cancel y.","4x=12→x=3. y=11−9=2."]},
    {num:5,q:"If |2x − 6| = 10, what are all possible values of x?",opts:["8 only","−2 only","3 and −5","8 and −2","2 and −8"],ans:3,topic:"algebra",exp:"x=8 or x=−2.",tutorial:["📌 Two cases: +10 and −10.","2x−6=10→x=8. 2x−6=−10→x=−2."]},
    {num:6,q:"What is the slope of the line passing through the points (−1, 4) and (3, −4)?",opts:["2","−2","1/2","−1/2","0"],ans:1,topic:"algebra",exp:"(−4−4)/(3+1)=−2.",tutorial:["📌 m=(y₂−y₁)/(x₂−x₁).","(−8)/(4)=−2."]},
    {num:7,q:"Given that 2x − 4 > 0 and 3x + 6 < 24, what is the range of x?",opts:["x > 2","x < 6","0 < x < 8","2 < x < 6","−2 < x < 6"],ans:3,topic:"algebra",exp:"x>2 AND x<6.",tutorial:["📌 Solve each, then find overlap.","x>2 and x<6 → 2<x<6."]},
    {num:8,q:"For the equation 4x² + kx + 9 = 0 to have exactly one solution, what is the value of |k|?",opts:["6","9","12","16","18"],ans:2,topic:"algebra",exp:"k²=144 → |k|=12.",tutorial:["📌 b²−4ac=0. k²−4(4)(9)=0→k²=144→|k|=12."]},
    {num:9,q:"Simplify the expression (x² − 9) ÷ (x + 3), where x ≠ −3.",opts:["x + 3","x − 3","x² − 3","x − 9","x + 9"],ans:1,topic:"algebra",exp:"(x+3)(x−3)/(x+3)=x−3.",tutorial:["📌 Difference of squares: x²−9=(x+3)(x−3). Cancel (x+3)."]},
    {num:10,q:"A taxi charges a flat fee of $3 plus $1.75 per kilometre. If the total fare is $17, how far was the journey?",opts:["6 km","7 km","8 km","9 km","10 km"],ans:2,topic:"algebra",exp:"1.75k=14→k=8.",tutorial:["📌 3+1.75k=17→k=8."]},
    {num:11,q:"Given that (x + a)² = x² + 8x + 16, what is the value of a?",opts:["2","4","8","16","−4"],ans:1,topic:"algebra",exp:"2a=8→a=4.",tutorial:["📌 (x+a)²=x²+2ax+a². 2a=8→a=4."]}
  ]},
  4:{title:"Test 4 — Geometry & Measurement",difficulty:"Challenging",color:"bg-orange-500",light:"bg-orange-50",border:"border-orange-400",badge:"🟠",questions:[
    {num:1,q:"A right triangle has legs of length 6 and 8. What is the length of the hypotenuse?",opts:["10","11","12","14","√28"],ans:0,topic:"geometry",exp:"√(36+64)=10.",tutorial:["📌 a²+b²=c². 36+64=100→c=10."]},
    {num:2,q:"The radius of a circle is doubled. By what factor does the area increase?",opts:["2×","4×","2π×","8×","π×"],ans:1,topic:"geometry",exp:"π(2r)²=4πr². Factor=4.",tutorial:["📌 Area scales by k²=4."]},
    {num:3,q:"A rectangle has length L = 2W and a perimeter of 54. What is its area?",opts:["72","108","162","81","144"],ans:2,topic:"geometry",exp:"6w=54→w=9,l=18. Area=162.",tutorial:["📌 6w=54→w=9. Area=162."]},
    {num:4,q:"A triangle has interior angles of 55° and 75°. What is the measure of the third angle?",opts:["40°","45°","50°","60°","70°"],ans:2,topic:"geometry",exp:"180−130=50°.",tutorial:["📌 Angles sum to 180°. 180−55−75=50°."]},
    {num:5,q:"A cylinder has radius r = 3 and height h = 7. What is its volume? (Use π ≈ 3.14)",opts:["131.9","175.8","197.8","215.4","263.8"],ans:2,topic:"geometry",exp:"3.14×9×7=197.82.",tutorial:["📌 V=πr²h=3.14×9×7≈197.8."]},
    {num:6,q:"A trapezoid has parallel sides of 8 m and 12 m, and a perpendicular height of 5 m. What is its area?",opts:["40","50","60","70","80"],ans:1,topic:"geometry",exp:"½×20×5=50.",tutorial:["📌 ½(b₁+b₂)×h=½×20×5=50."]},
    {num:7,q:"A clock's minute hand is 10 cm long. How far does the tip of the minute hand travel in 20 minutes? (Use π ≈ 3.14)",opts:["20.9 cm","31.4 cm","41.9 cm","62.8 cm","125.6 cm"],ans:0,topic:"geometry",exp:"(1/3)×62.8≈20.9.",tutorial:["📌 (20/60)×2π×10=(1/3)×62.8≈20.9."]},
    {num:8,q:"A right triangle has a hypotenuse of 13 and one leg of length 5. What is the area of the triangle?",opts:["24","30","32.5","60","65"],ans:1,topic:"geometry",exp:"b=12. Area=½×5×12=30.",tutorial:["📌 b²=169−25=144→b=12. Area=30."]},
    {num:9,q:"One interior angle of a parallelogram measures 110°. What is the measure of an adjacent interior angle?",opts:["55°","70°","80°","110°","90°"],ans:1,topic:"geometry",exp:"180−110=70°.",tutorial:["📌 Adjacent angles sum to 180°."]},
    {num:10,q:"A square has a side length of 6. What is the length of its diagonal?",opts:["6√2","6√3","12","9","6"],ans:0,topic:"geometry",exp:"d=6√2.",tutorial:["📌 d=s√2. 6√2."]},
    {num:11,q:"A cube has a total surface area of 150 cm². What is the length of one side?",opts:["4","5","6","7","25"],ans:1,topic:"geometry",exp:"6s²=150→s=5.",tutorial:["📌 6s²=150→s²=25→s=5."]}
  ]},
  5:{title:"Test 5 — Probability & Statistics",difficulty:"Hard",color:"bg-rose-600",light:"bg-rose-50",border:"border-rose-400",badge:"🔴",questions:[
    {num:1,q:"A bag contains 4 red, 3 blue, and 5 green marbles. What is the probability of drawing a marble that is NOT red?",opts:["1/3","1/4","2/3","3/4","5/12"],ans:2,topic:"probability",exp:"8/12=2/3.",tutorial:["📌 P(not red)=1−4/12=2/3."]},
    {num:2,q:"Two fair six-sided dice are rolled simultaneously. What is the probability that the sum of the two dice is greater than or equal to 10?",opts:["1/6","1/12","5/36","1/9","7/36"],ans:0,topic:"probability",exp:"6/36=1/6.",tutorial:["📌 Pairs summing to 10,11,12: 6 pairs. P=6/36=1/6."]},
    {num:3,q:"The mean of 5 numbers is 12. A sixth number is added and the new mean becomes 13. What is the sixth number?",opts:["13","14","16","18","20"],ans:3,topic:"statistics",exp:"78−60=18.",tutorial:["📌 78−60=18."]},
    {num:4,q:"In how many different ways can 5 students be arranged in a single line?",opts:["25","60","100","120","150"],ans:3,topic:"combinatorics",exp:"5!=120.",tutorial:["📌 5!=120."]},
    {num:5,q:"A fair coin is flipped 4 times. What is the probability of obtaining exactly 2 heads?",opts:["1/4","3/8","1/2","5/16","3/16"],ans:1,topic:"probability",exp:"C(4,2)/16=3/8.",tutorial:["📌 C(4,2)=6. P=6/16=3/8."]},
    {num:6,q:"What is the median of the following data set: {14, 7, 22, 10, 18, 3, 15}?",opts:["10","14","15","7","18"],ans:1,topic:"statistics",exp:"Sorted: 3,7,10,14,15,18,22. Median=14.",tutorial:["📌 Sort, find middle. 4th=14."]},
    {num:7,q:"In how many ways can a committee of 3 people be selected from a group of 8 people?",opts:["24","56","112","168","336"],ans:1,topic:"combinatorics",exp:"C(8,3)=56.",tutorial:["📌 C(8,3)=56."]},
    {num:8,q:"What is the mode of the following data set: {5, 5, 8, 12, 15}?",opts:["8","9","5","12","No mode"],ans:2,topic:"statistics",exp:"Mode=5.",tutorial:["📌 Most frequent=5."]},
    {num:9,q:"The probability that an item is defective is 3%. If two items are selected independently, what is the probability that both items are defective?",opts:["0.0009","0.006","0.009","0.06","0.09"],ans:0,topic:"probability",exp:"0.03²=0.0009.",tutorial:["📌 0.03×0.03=0.0009."]},
    {num:10,q:"What is the range of the following data set: {42, 17, 88, 55, 31, 72}?",opts:["55","46","66","71","72"],ans:3,topic:"statistics",exp:"88−17=71.",tutorial:["📌 Maximum − Minimum = 88 − 17 = 71."]},
    {num:11,q:"Events A and B are mutually exclusive. If P(A) = 0.3 and P(B) = 0.45, what is P(A or B)?",opts:["0.135","0.45","0.3","0.75","1.0"],ans:3,topic:"probability",exp:"0.3+0.45=0.75.",tutorial:["📌 Mutually exclusive: P(A∪B)=P(A)+P(B)=0.75."]}
  ]},
  6:{title:"Test 6 — Advanced Mixed Mastery",difficulty:"Expert",color:"bg-slate-700",light:"bg-slate-50",border:"border-slate-500",badge:"⚫",questions:[
    {num:1,q:"Train P departs at 9:00 AM travelling at 90 km/h. Train Q departs from the same point at 11:00 AM travelling in the same direction at 150 km/h. At what time does Train Q catch up with Train P?",opts:["1:00 PM","2:00 PM","3:00 PM","4:00 PM","5:00 PM"],ans:1,topic:"algebra",exp:"Head start=180km. 180÷60=3h → 2PM.",tutorial:["📌 Head start÷closing speed=time. 2PM."]},
    {num:2,q:"$2,000 is invested at an annual interest rate of 5%, compounded annually. What is the value of the investment after 3 years?",opts:["$2,100","$2,205","$2,300","$2,315.25","$2,400"],ans:3,topic:"arithmetic",exp:"2000×1.05³=$2315.25.",tutorial:["📌 A=P(1+r)ᵗ. 2000×1.157625=$2315.25."]},
    {num:3,q:"If log₂(x) = 5, what is the value of x?",opts:["10","16","25","32","64"],ans:3,topic:"algebra",exp:"2⁵=32.",tutorial:["📌 logₐ(x)=b↔aᵇ=x. 2⁵=32."]},
    {num:4,q:"How many integers from 1 to 300 are divisible by both 4 and 6?",opts:["20","25","37","50","75"],ans:1,topic:"number-theory",exp:"LCM(4,6)=12. 300÷12=25.",tutorial:["📌 LCM(4,6)=12. ⌊300/12⌋=25."]},
    {num:5,q:"What is the sum of the interior angles of a regular hexagon?",opts:["540°","600°","720°","900°","1080°"],ans:2,topic:"geometry",exp:"(6−2)×180=720°.",tutorial:["📌 (n−2)×180. (6−2)×180=720."]},
    {num:6,q:"The first four terms of a geometric sequence are 2, 6, 18, 54. What is the 7th term of the sequence?",opts:["729","1,458","2,187","4,374","6,561"],ans:1,topic:"algebra",exp:"2×3⁶=1458.",tutorial:["📌 aₙ=a₁×rⁿ⁻¹. 2×3⁶=1458."]},
    {num:7,q:"Working alone, Worker A can complete a job in 6 hours and Worker B can complete the same job in 4 hours. How long will the job take if they work together?",opts:["1.5 hours","2 hours","2.4 hours","3 hours","5 hours"],ans:2,topic:"algebra",exp:"1/6+1/4=5/12→time=12/5=2.4h.",tutorial:["📌 Add rates: 1/6+1/4=5/12. Time=12/5=2.4h."]},
    {num:8,q:"Given that x/y = 3/4 and x + y = 35, what is the value of x − y?",opts:["−7","5","−5","7","15"],ans:2,topic:"algebra",exp:"x=15,y=20. x−y=−5.",tutorial:["📌 x=3k,y=4k. 7k=35→k=5. x−y=−5."]},
    {num:9,q:"A sector of a circle has radius 6 and a central angle of 60°. What is the area of the sector? (Use π ≈ 3.14)",opts:["6.28","9.42","18.84","37.68","113.04"],ans:2,topic:"geometry",exp:"(1/6)×3.14×36=18.84.",tutorial:["📌 (60/360)×πr²=18.84."]},
    {num:10,q:"The mean of 6 numbers is 15. One of the numbers, 9, is removed from the set. What is the new mean of the remaining 5 numbers?",opts:["15","16.2","17","18","20"],ans:1,topic:"statistics",exp:"81÷5=16.2.",tutorial:["📌 (90−9)/5=16.2."]},
    {num:11,q:"How many distinct arrangements can be made using all four letters of the word MATH?",opts:["4","12","16","24","48"],ans:3,topic:"combinatorics",exp:"4!=24.",tutorial:["📌 4!=24."]}
  ]}
};
